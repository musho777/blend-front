...
import QueryStateWrapper from "@/components/QueryStates/QueryStateWrapper";
...
const RestaurantMenu = ({ menus }) => {
  ...
  // Use data from API if available, otherwise fall back to hardcoded data or prop
  const items = menuQuery.data || menus || [
        {
          id: 1,
          title: "dessert",
