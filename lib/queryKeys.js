export const queryKeys = {
  ...
  products: {
    ...
    byCategory: (categoryId, page, limit, subcategoryId = null, search = null, sortBy = null, minPrice = null, maxPrice = null) => [
      ...queryKeys.products.all,
      "category",
      categoryId,
      { page, limit, subcategoryId, search, sortBy, minPrice, maxPrice },
    ],
